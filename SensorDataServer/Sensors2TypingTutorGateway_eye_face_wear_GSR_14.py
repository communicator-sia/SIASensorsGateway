...
receivedMultiLuxAccel.append(json.loads('{"multiLuxAccel":{"timestamp":"1479298905687","accel":{"ax":"234","ay":"23","az":"23"},"gyro":{"gx":"23","gy":"23","gz":"32"}}}'))
receivedMultiLuxAccel.append(json.loads('{"multiLuxAccel":{"timestamp":"1479298905707","accel":{"ax":"234","ay":"23","az":"23"},"gyro":{"gx":"23","gy":"23","gz":"32"}}}'))
...
receivedMultiLuxGSR=[] 
receivedMultiLuxGSR.append(json.loads('{"multiLuxGSR":{"timestamp":"1479298905687","resistanceOhm":{"Ra":"23","Rb":"34"}}}'))
receivedMultiLuxGSR.append(json.loads('{"multiLuxGSR":{"timestamp":"1479298905707","resistanceOhm":{"Ra":"23","Rb":"34"}}}'))
...
def listenGSRSocket():
    ...
    while multiLuxGSRSocketRunning:
        ...
        #https://wiki.python.org/moin/HandlingExceptions
        try:
            print >>sys.stderr, 'Server socket for incomming data: connection 212 from', client_address
            ...
            while multiLuxGSRSocketRunning:
                ...
                try:
                    ...
                    print 'Exception while parsing received JSON message from GSR.'
                    if multiLuxGSRDataLocalFileLogging:
                        # for console data logging
                        f = open(multiLuxGSRDataLocalFileLoggingFileName,'a')
                        f.write('Exception while parsing received JSON message')
...
# @primozkocevar
###############################################################################
# cleanup is not correctly implemented.
